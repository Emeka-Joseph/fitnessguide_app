...
from fitnessguide.models import Options, Employment,Environment,Lifestyle,Personality,Relationship,Symptoms,Categories,Readjustment,Sed_Lifestyle
...
def sed_lifestyle():
    ...
    if request.method=='GET':
        ...
        # else:
        catv = "UPDATE Readjustment SET srs_score = (SELECT SUM(no_hrs) FROM sed_lifestyle) WHERE srs_name = 'sedentary lifestyle'"
